...
- **lock the star-map contract**: published JSON schema, `prism starmap --validate`, golden fixtures a consumer's CI can run. compatibility should be machine-checked, not discipline
